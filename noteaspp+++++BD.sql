...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-01-2019 a las 01:51:54
...
--
-- Base de datos: `noteaspp`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `follow_system`
--
...
--
-- Volcado de datos para la tabla `follow_system`
--
...
(107, 9, 'admin@admin.com', 7, 'ghalib', '1548184333498'),
(108, 9, 'admin@admin.com', 6, 'faiyaz', '1548184334686');
...
(87, 9, 'admin@admin.com', 'Nota1', 'Primera nota', '1548184325761');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `profile_views`
--
...
--
-- Volcado de datos para la tabla `profile_views`
--
...
(126, 9, 'admin@admin.com', 5, '1548184336154'),
(127, 9, 'takkar', 5, '1548636310258');
...
(5, 'takkar', 'takkar@gmail.com', '$2a$10$ppEiY6w/BMVI4GGhtWtc0.VogTTr7Y3mKyQZsPhQJWYc/SoDbSjqW', 'Developer of Instagram.', 'yes', '1497128558168'),
...
(9, 'admin@admin.com', 'admin@admin.com', '$2a$10$ppEiY6w/BMVI4GGhtWtc0.VogTTr7Y3mKyQZsPhQJWYc/SoDbSjqW', 'Programador', 'yes', '1497279682801');
...
--
-- Indices de la tabla `follow_system`
--
...
--
-- Indices de la tabla `profile_views`
--
...
--
-- AUTO_INCREMENT de la tabla `follow_system`
--
ALTER TABLE `follow_system`
  MODIFY `follow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
--
...
--
ALTER TABLE `notes`
  MODIFY `note_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT de la tabla `profile_views`
--
ALTER TABLE `profile_views`
  MODIFY `view_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=128;
--
