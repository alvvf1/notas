        ...
        <div class='edit'>
          ...
          <FadeIn duration="300ms" className="edit_animation" >
            ...
            <div className="eu_div">
              <span class='edit_span'>Nombre de usuario</span>
              <input
                type="text"
                class='e_username'
                placeholder='Nombre...'
            ...
            <div className="eb_div">
              <span class='edit_span'>Biografía</span>
              <textarea
                class="e_bio"
            ...
            <div className="eb_btns">
              <form class='avatar_form' method="post" encType='multipart/formdata' >
                ...
                >{fn.e_v() ? "Cambiar avatar" : "Verifique email para cambiar avatar"}</label>
              </form>
              <a href="#" className="pri_btn e_done" onClick={this.edit_profile} >Editar</a>
            </div>
            <div className="e_joined">
              <span>{`Te has unido a AV RedSocialNotas ${TimeAgo(joined)}`}</span>
            </div>
