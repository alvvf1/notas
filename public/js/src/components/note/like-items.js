        ...
        <div className="modal_items fer_items" >
          ...
          <div className="modal_it_content">
            ...
            <div className="modal_ff">
              {
                fn.Me(like_by) ?
                  <Link to={`/profile/${like_by}`} class='pri_btn follow'  > Perfil</Link>
                : is_following ?
                  <a href="#" class='pri_btn unfollow' onClick={this.unfollow} >No seguir</a>
                :
                  <a href="#" class='pri_btn follow' onClick={this.follow} >Seguir</a>
              }
            </div>
          </div>
